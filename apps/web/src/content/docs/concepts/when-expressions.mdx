...
- [useScope](/react/use-scope/) — the React convenience layer over context keys
- [Collision detection](/concepts/collisions/) — what happens when two gated rules overlap
- [Recipes](/guides/recipes/) — palettes and modals built on when-gating
