---
title: 'useShortcut: a React keyboard shortcut hook'
sidebar:
  label: useShortcut
...
- [useScope](/react/use-scope/) — drive the `when` context from components
- [Key syntax](/concepts/key-syntax/) — everything `keys` accepts
- [Playground](/playground/) — see these rules running live
